 ...
 * @property Smarty_Internal_TemplateCompilerBase $compiler The following methods will be dynamically loaded by the extension handler when they are called.
...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase {
	...
	public function _decodeProperties(Smarty_Internal_Template $tpl, $properties, $cache = false) {
		...
		$is_valid = true;
		if (! empty ( $properties ['file_dependency'] ) && ((! $cache && $tpl->smarty->compile_check) || $tpl->smarty->compile_check == 1)) {
